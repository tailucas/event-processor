...
.PHONY: help check dev dev-build dev-up datadir python java spotbugs configure build push run rund
...
spotbugs: ## Run SpotBugs static analysis (fails on any finding; also runs during mvn package)
